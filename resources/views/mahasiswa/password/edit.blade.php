        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="/mahasiswa/dashboard">Ganti Password</a></div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('mahasiswa.password.update', $data_user) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control pwstrength"
                                                data-indicator="pwindicator" id="password_baru" name="password_baru"
                                    ...
                                    <a href="/dosen/dashboard" class="btn btn-primary">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </div>

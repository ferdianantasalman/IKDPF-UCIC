...
@push('style')
    ...
    <link rel="stylesheet" href="{{ asset('assets_admin/library/codemirror/lib/codemirror.css') }}">
    <link rel="stylesheet" href="{{ asset('assets_admin/library/codemirror/theme/duotone-dark.css') }}">
...
@push('scripts')
    ...
    <script src="{{ asset('assets_admin/library/codemirror/lib/codemirror.js') }}"></script>
    <script src="{{ asset('assets_admin/library/codemirror/mode/javascript/javascript.js') }}"></script>

...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('assets_admin/library/izitoast/dist/css/iziToast.min.css') }}">
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('assets_admin/library/izitoast/dist/js/iziToast.js') }}"></script>
    ...
    <script src="{{ asset('assets_admin/js/page/modules-vector-map.js') }}"></script>
@endpush

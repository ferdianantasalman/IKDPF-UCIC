...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('assets_admin/library/dropzone/dist/dropzone.css') }}">
@endpush
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('assets_admin/library/dropzone/dist/min/dropzone.min.js') }}"></script>

    <!-- Page Specific JS File -->
    <script src="{{ asset('assets_admin/js/page/components-multiple-upload.js') }}"></script>
@endpush

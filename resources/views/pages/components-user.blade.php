...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('assets_admin/library/bootstrap-social/bootstrap-social.css') }}">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                                    ...
                                    <li class="media">
                                        <img alt="image" class="rounded-circle mr-3" width="70"
                                            src="{{ asset('assets_admin/img/avatar/avatar-2.png') }}">
                                        <div class="media-body">
                                            <div class="media-right">
                                    ...
                                    <li class="media">
                                        <img alt="image" class="rounded-circle mr-3" width="70"
                                            src="{{ asset('assets_admin/img/avatar/avatar-3.png') }}">
                                        <div class="media-body">
                                            <div class="media-right">
                                                <div class="text-primary">Approved</div>
                                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled user-progress list-unstyled-border list-unstyled-noborder">
                                    ...
                                    <li class="media">
                                        <img alt="image" class="rounded-circle mr-3" width="50"
                                            src="{{ asset('assets_admin/img/avatar/avatar-4.png') }}">
                                        <div class="media-body">
...
@push('scripts')
    ...
    <script src="{{ asset('assets_admin/js/page/components-user.js') }}"></script>
@endpush

...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet"
        href="{{ asset('assets_admin/library/bootstrap-daterangepicker/daterangepicker.css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets_admin/library/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets_admin/library/select2/dist/css/select2.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets_admin/library/selectric/public/selectric.css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets_admin/library/bootstrap-timepicker/css/bootstrap-timepicker.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('assets_admin/library/bootstrap-tagsinput/dist/bootstrap-tagsinput.css') }}">
@endpush
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                ...
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('assets_admin/img/news/img01.jpg') }}"
                                                        alt="}"
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    checked />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('assets_admin/img/news/img02.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('assets_admin/img/news/img03.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    checked />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('assets_admin/img/news/img04.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('assets_admin/img/news/img05.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>
                                        ...
                                        <div class="col-6 col-sm-4">
                                            <label class="imagecheck mb-4">
                                                <input name="imagecheck"
                                                    ...
                                                    class="imagecheck-input" />
                                                <figure class="imagecheck-figure">
                                                    <img src="{{ asset('assets_admin/img/news/img06.jpg') }}"
                                                        alt="}"
                                                        class="imagecheck-image">
                                                </figure>
                                            </label>

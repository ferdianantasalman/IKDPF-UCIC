                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <img class="mr-3" src="{{ asset('assets_admin/img/example-image-50.jpg') }}"
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media mt-3">
                                            <a class="pr-3" href="#">
                                                <img src="{{ asset('assets_admin/img/example-image-50.jpg') }}"
                                                    alt="Generic placeholder image">
                                            </a>
                                            <div class="media-body">
                                                <h5 class="mt-0">Media heading</h5>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    ...
                                    <img class="ml-3" src="{{ asset('assets_admin/img/example-image-50.jpg') }}"
                                        alt="Generic placeholder image">
                                </div>
                            </div>
                        </div>

...
@push('style')
    ...
    <link rel="stylesheet" href="{{ asset('assets_admin/library/chocolat/dist/css/chocolat.css') }}">
@endpush
                                    ...
                                    <div class="ticket-content">
                                        <div class="ticket-header">
                                            <div class="ticket-sender-picture img-shadow">
                                                <img src="{{ asset('assets_admin/img/avatar/avatar-5.png') }}"
                                                    alt="image">
                                            </div>
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('assets_admin/library/summernote/dist/summernote-bs4.js') }}"></script>

...
@push('style')
    ...
    <link rel="stylesheet" href="{{ asset('assets_admin/library/flag-icon-css/css/flag-icon.min.css') }}">
@endpush
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                <li class="media">
                                    <img class="mr-3 rounded" width="55"
                                        src="{{ asset('assets_admin/img/products/product-3-50.png') }}" alt="product">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded" width="55"
                                        src="{{ asset('assets_admin/img/products/product-4-50.png') }}" alt="product">
                                    <div class="media-body">
                                        <div class="float-right">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded" width="55"
                                        src="{{ asset('assets_admin/img/products/product-1-50.png') }}" alt="product">
                                    <div class="media-body">
                                        <div class="float-right">
                                ...
                                <li class="media">
                                    <img class="mr-3 rounded" width="55"
                                        src="{{ asset('assets_admin/img/products/product-5-50.png') }}" alt="product">
                                    <div class="media-body">
                                        <div class="float-right">
                                ...
                                <div>
                                    <div class="product-item pb-3">
                                        <div class="product-image">
                                            <img alt="image"
                                                src="{{ asset('assets_admin/img/products/product-4-50.png') }}"
                                                class="img-fluid">
                                        </div>
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('assets_admin/library/jquery-sparkline/jquery.sparkline.min.js') }}"></script>
    <script src="{{ asset('assets_admin/library/chart.js/dist/Chart.js') }}"></script>

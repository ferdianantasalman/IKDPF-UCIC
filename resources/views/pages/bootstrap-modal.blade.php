...
@push('style')
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('assets_admin/library/prismjs/themes/prism.min.css') }}">
@endpush
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('assets_admin/library/prismjs/prism.js') }}"></script>

    <!-- Page Specific JS File -->
    <script src="{{ asset('assets_admin/s/page/bootstrap-modal.js') }}"></script>
@endpush

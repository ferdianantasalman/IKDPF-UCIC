                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chocolat-parent">
                                    <a href="{{ asset('assets_admin/img/example-image.jpg') }}" class="chocolat-image"
                                        title="Just an example">
                                        <div data-crop-image="285">
                                            <img alt="image" src="{{ asset('assets_admin/img/example-image.jpg') }}"
                                                class="img-fluid">
                                        </div>
                                    </a>
                                </div>
...
@push('scripts')
    ...
    <script src="{{ asset('assets_admin/library/jquery-ui-dist/jquery-ui.min.css') }}"></script>

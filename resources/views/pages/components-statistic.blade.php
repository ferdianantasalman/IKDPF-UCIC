...
@push('scripts')
    ...
    <script src="{{ asset('assets_admin/library/jqvmap/dist/maps/jquery.vmap.indonesia.js') }}"></script>

    <!-- Page Specific JS File -->
    <script src="{{ asset('assets_admin/js/page/components-statistic.js') }}"></script>
@endpush

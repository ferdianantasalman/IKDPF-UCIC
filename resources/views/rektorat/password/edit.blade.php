        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="/rektorat/dashboard">Ganti Passwor</a></div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('password.update', $data->id) }}" method="POST">
                                    ...
                                    <a href="/rektorat/dashboard" class="btn btn-primary">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </div>

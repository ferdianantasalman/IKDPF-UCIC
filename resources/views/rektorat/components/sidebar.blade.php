<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="/rektorat/dashboard">SIKAD UCIC</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                <a class="nav-link" href="/rektorat/dashboard"><i class="far fa-fire"></i> <span>Dashboard</span></a>
            </li>
            <li class="menu-header">Menu</li>
            <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                <a class="nav-link" href="/rektorat/profile"><i class="far fa-square"></i> <span>Data
                        Diri</span></a>
            </li>
            <li class="nav-item dropdown {{ $type_menu === 'kinerja' ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Request::is('auth-forgot-password') ? 'active' : '' }}">
                        <a href="/rektorat/kinerja_pendidikan">Kinerja Pendidikan</a>
                    </li>
                    <li class="{{ Request::is('auth-login') ? 'active' : '' }}">
                        <a href="/rektorat/kinerja_penelitian">Kinerja Penelitian</a>
                    </li>
                    <li class="{{ Request::is('auth-login2') ? 'active' : '' }}">
                        <a class="beep beep-sidebar" href="/rektorat/kinerja_pengabdian">Kinerja Pengabdian</a>
                    </li>
                    <li class="{{ Request::is('auth-login2') ? 'active' : '' }}">
                        <a class="beep beep-sidebar" href="/rektorat/kinerja_penunjang">Kinerja Penunjang</a>
                    </li>
                </ul>
            </li>

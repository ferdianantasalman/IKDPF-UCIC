    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Data Kinerja Penelitian</h1>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.kinerja_penelitian.update', $data->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <a href="/admin/kinerja_penelitian" class="btn btn-primary">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </div>

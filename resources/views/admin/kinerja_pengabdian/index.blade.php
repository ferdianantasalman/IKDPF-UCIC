    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Kinerja Pengabdian</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="/admin/dashboard">Data Kinerja</a></div>
                    {{-- <div class="breadcrumb-item active"><a href="#">Data Dosen</a></div> --}}
                    <div class="breadcrumb-item">Kinerja Pengabdian</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="kinerja_pengabdian/create" class="btn btn-primary">Tambah Data</a>
                            </div>
                            {{-- <div class="card-header">
                                <h4>Data Dosen</h4>
                            </div> --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="{{ route('admin.kinerja_pengabdian.edit', $dt->id) }}"
                                                                class="btn btn-icon btn-primary"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <form
                                                                action="{{ route('admin.kinerja_pengabdian.destroy', $dt->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"

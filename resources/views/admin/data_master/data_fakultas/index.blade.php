        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    {{-- <div class="breadcrumb-item active"><a href="#">Data fakultas</a></div> --}}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="data_fakultas/create" class="btn btn-primary">Tambah Data</a>
                            </div>
                            {{-- <div class="card-header">
                                <h4>Data fakultas</h4>
                            </div> --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="{{ route('data_fakultas.edit', $dt->id) }}"
                                                                class="btn btn-icon btn-primary"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <form action="{{ route('data_fakultas.destroy', $dt->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"

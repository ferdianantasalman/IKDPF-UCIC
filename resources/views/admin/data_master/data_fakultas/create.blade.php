    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Tambah Data Fakutas</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="/admin/data_dosen">Master Data</a></div>
                    <div class="breadcrumb-item"><a href="/admin/data_dosen">Data Fakultas</a></div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/admin/data_fakultas" method="POST">
                                    @csrf
                                    ...
                                    <a href="/admin/data_fakultas" class="btn btn-primary">Kembali</a>
                                </form>

        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="/admin/pertanyaan">Pertanyaan</a></div>
                                        ...
                                        <tbody>
                                            @foreach ($data as $dt)
                                                <tr>
                                                    ...
                                                    @if ($dt->tipe == 'pilihan')
                                                        <td><a href="{{ $dt->question_text ?: 'Belum terisi' }}"
                                                                target="_blank"
                                                                rel="noopener noreferrer">{{ $dt->question_text ?: 'Belum terisi' }}</a>
                                                        </td>
                                                    @else
                                                    ...
                                                    <td>{{ $dt->status ?: 'Belum terisi' }}</td>
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="{{ route('admin.pertanyaan.edit', $dt->id) }}"
                                                                class="btn btn-icon btn-primary"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <form action="{{ route('admin.pertanyaan.destroy', $dt->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"

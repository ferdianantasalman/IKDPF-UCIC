    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Edit Data Kinerja Pendidikan</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Master Data</a></div>
                    <div class="breadcrumb-item"><a href="#">Data Kinerja Pendidikan</a></div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.kinerja_pendidikan.update', $data->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <a href="/admin/kinerja_pendidikan" class="btn btn-primary">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </div>

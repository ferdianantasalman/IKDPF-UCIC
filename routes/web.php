...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('admin')->middleware('roleAs:admin')->group(function () {
        ...
        Route::get('hasil_atasan', [ResultController::class, 'index_atasan'])->name('admin.atasan.result');
        Route::get('hasil_mahasiswa', [ResultController::class, 'index_mahasiswa'])->name('admin.mahasiswa.result');
    });

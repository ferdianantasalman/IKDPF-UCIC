...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::prefix('admin')->middleware('roleAs:admin')->group(function () {
        ...
        // Tahun Akademik
        Route::get('tahun_akademik', [TahunAkademikController::class, 'index'])->name('tahun_akademik');
        ...
        Route::get('tahun_akademik/{tahun_akademik}/edit', [TahunAkademikController::class, 'edit'])->name('tahun_akademik.edit');
        Route::put('tahun_akademik/{tahun_akademik}', [TahunAkademikController::class, 'update'])->name('tahun_akademik.update');
        Route::delete('tahun_akademik/{tahun_akademik}', [TahunAkademikController::class, 'destroy'])->name('tahun_akademik.destroy');
        ...
        Route::get('pertanyaan', [QuestionController::class, 'index'])->name('admin.pertanyaan');
        Route::get('pertanyaan/create', [QuestionController::class, 'create'])->name('admin.pertanyaan.create');
        Route::post('pertanyaan', [QuestionController::class, 'store'])->name('admin.pertanyaan.store');
        Route::get('pertanyaan/{pertanyaan}/edit', [QuestionController::class, 'edit'])->name('admin.pertanyaan.edit');
        Route::put('pertanyaan/{pertanyaan}', [QuestionController::class, 'update'])->name('admin.pertanyaan.update');
        Route::delete('pertanyaan/{pertanyaan}', [QuestionController::class, 'destroy'])->name('admin.pertanyaan.destroy');
        Route::delete('pertanyaan_mass_destroy', [QuestionController::class, 'massDestroy'])->name('pertanyaan.mass_destroy');

        // Pertanyaan Atasan
        Route::get('pertanyaan_atasan', [QuestionController::class, 'index_atasan'])->name('admin.pertanyaan_atasan');
        Route::get('pertanyaan_atasan/create', [QuestionController::class, 'create_atasan'])->name('admin.pertanyaan_atasan.create');
        Route::post('pertanyaan_atasan', [QuestionController::class, 'store_atasan'])->name('admin.pertanyaan_atasan.store');
        Route::get('pertanyaan_atasan/{pertanyaan}/edit', [QuestionController::class, 'edit_atasan'])->name('admin.pertanyaan_atasan.edit');
        Route::put('pertanyaan_atasan/{pertanyaan}', [QuestionController::class, 'update_atasan'])->name('admin.pertanyaan_atasan.update');
        Route::delete('pertanyaan_atasan/{pertanyaan}', [QuestionController::class, 'destroy_atasan'])->name('admin.pertanyaan_atasan.destroy');

        // Pertanyaan Mahasiswa
        Route::get('pertanyaan_mahasiswa', [QuestionController::class, 'index_mahasiswa'])->name('admin.pertanyaan_mahasiswa');
        Route::get('pertanyaan_mahasiswa/create', [QuestionController::class, 'create_mahasiswa'])->name('admin.pertanyaan_mahasiswa.create');
        Route::post('pertanyaan_mahasiswa', [QuestionController::class, 'store_mahasiswa'])->name('admin.pertanyaan_mahasiswa.store');
        Route::get('pertanyaan_mahasiswa/{pertanyaan}/edit', [QuestionController::class, 'edit_mahasiswa'])->name('admin.pertanyaan_mahasiswa.edit');
        Route::put('pertanyaan_mahasiswa/{pertanyaan}', [QuestionController::class, 'update_mahasiswa'])->name('admin.pertanyaan_mahasiswa.update');
        Route::delete('pertanyaan_mahasiswa/{pertanyaan}', [QuestionController::class, 'destroy_mahasiswa'])->name('admin.pertanyaan_mahasiswa.destroy');
        ...
        // Jawaban Pertanyaan
        Route::get('jawaban_pertanyaan/{pertanyaan}', [OptionController::class, 'index_pertanyaan'])->name('admin.jawaban_pertanyaan');
        Route::get('jawaban_pertanyaan/create/{pertanyaan}', [OptionController::class, 'create_pertanyaan'])->name('admin.jawaban_pertanyaan.create');
        Route::post('jawaban_pertanyaan', [OptionController::class, 'store_pertanyaan'])->name('admin.jawaban_pertanyaan.store');
        Route::get('jawaban_pertanyaan/{jawaban}/edit', [OptionController::class, 'edit_pertanyaan'])->name('admin.jawaban_pertanyaan.edit');
        Route::put('jawaban_pertanyaan/{jawaban}', [OptionController::class, 'update_pertanyaan'])->name('admin.jawaban_pertanyaan.update');
        Route::delete('jawaban_pertanyaan/{jawaban}', [OptionController::class, 'destroy_pertanyaan'])->name('admin.jawaban_pertanyaan.destroy');

        // Result
        Route::resource('results', ResultController::class);
        // Atasan
        Route::get('hasil_atasan', [ResultController::class, 'index_atasan'])->name('admin.atasan_result');
        Route::get('hasil_atasan/{result}', [ResultController::class, 'show_atasan'])->name('admin.atasan_result.show');
        // Mahasiswa
        Route::get('hasil_mahasiswa', [ResultController::class, 'index_mahasiswa'])->name('admin.mahasiswa_result');
        Route::get('hasil_mahasiswa/{result}', [ResultController::class, 'show_mahasiswa'])->name('admin.mahasiswa_result.show');
    });
    ...
    Route::prefix('dosen')->middleware('roleAs:dosen')->group(function () {
        ...
        Route::get('profile/{profile}/edit', [UserController::class, 'edit_data_dosen'])->name('dosen.profile.edit');
        Route::put('profile/{profile}', [UserController::class, 'update_profile'])->name('dosen.profile.update');
        Route::delete('profile/{profile}', [UserController::class, 'destroy_data_dosen'])->name('dosen.profile.destroy');
        // chande password
    ...
    // ============== Mahasiswa ============
    Route::prefix('mahasiswa')->middleware('roleAs:mahasiswa')->group(function () {
        Route::get('dashboard', [HomeController::class, 'mahasiswa']);
        ...
        // Penilaian
        Route::get('penilaian/create', [TestController::class, 'create_mahasiswa'])->name('mahasiswa.penilaian');
        Route::post('penilaian', [TestController::class, 'store_mahasiswa'])->name('mahasiswa.penilaian.store');

        // Result Penilaian
        Route::get('hasil_penilaian', [ResultController::class, 'index_mahasiswa'])->name('mahasiswa.result_penilaian');
        Route::get('hasil_penilaian/{result}', [ResultController::class, 'show_mahasiswa'])->name('mahasiswa.result_penilaian.show');
    });
});
